...
require_once('http://csis.svsu.edu/~artaylo2/public_html/cis355/assignment06/students.php');

// Because a WSDL isn't used we must provide a URI for the service
$options = array("uri" => "https://csis.svsu.edu/~artaylo2/cis355/assignment06");
