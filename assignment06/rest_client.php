...
if(isset($_GET["action"]) == "get_student"){
    ...
    $student_info = file_get_contents('https://csis.svsu.edu/~artaylo2/cis355/assignment06/api.php?action=get_student&id=' . $_GET["id"]);
...
<?php
 ...
 
 {
    ...
    $student_list = file_get_contents('https://csis.svsu.edu/~artaylo2/cis355/assignment06/api.php?action=get_student_list');
...
<a href=<?php echo
"https://csis.svsu.edu/~artaylo2/cis355/assighnment06/rest_client.php?action=get_student&id=" . $student["id"] ?>><?php echo $student["name"] ?></a><br />
