...
if(isset($_POST['upload']) && $_FILES['userfile']['size']>0)
{
  ...
  $con = mysql_connect('localhost','artaylo2','381714') 
    or die(mysql_error());
  $db  = mysql_select_db('artaylo2',$con);
  if($db)
  {
    $query = "INSERT INTO files_practice (name, size, type, content) ".
	  "VALUES ('$fileName', '$fileSize', '$fileType', '$content')";
	mysql_query($query) or die('Error... query failed!');
	mysql_close();
	echo "<br />File $fileName <br />uploaded successfully! you did it!<br />";
  }
  else
  {
